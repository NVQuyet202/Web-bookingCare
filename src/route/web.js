...
let initWebRoutes = (app) => {
  ...
  router.get("/api/get-detail-doctor-by-id", doctorController.getDetailById);
  ...
  router.get("/api/get-profile-doctor-by-id", doctorController.getProfileById);
  router.get(
  ...
  router.put("/api/edit-clinic-by-id", clinicController.handleEditClinic);
  router.delete(
